...
fun Strings.ja(): String? =
    when (this) {
        ...
        ExceptionUnsupportedAudioDevice ->
            "選択されたオーディオデバイスは使用できません。システム側のオーディオ設定を確認してください。" +
                "このエラーが続く場合は、RecStar の設定でシステムデフォルトのオーディオデバイスを選択し、" +
                "システム設定で希望のオーディオデバイスを選択してみてください。"
        ...
        GuideAudioScreenAllGuideAudios -> "ガイド BGM"
