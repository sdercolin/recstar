...
fun Strings.ru(): String =
    when (this) {
        ...
        CommonStillLoad -> "Всё равно загрузить"
        ...
        ExceptionUnsupportedAudioDevice ->
            "Выбранное аудиоустройство не может быть использовано, проверьте настройки звука " +
                "на стороне вашей системы. Если эта ошибка повторяется, попробуйте выбрать " +
                "аудиоустройства по умолчанию в настройках RecStar и выберите нужные " +
                "аудиоустройства в системных настройках."
        ExceptionReclistNotFound ->
            "Не удалось открыть сессию, потому что не найден реклист ({0}) или его файл " +
                "комментариев, используемый в этой сессии. " +
                "Пожалуйста, импортируйте их заново, чтобы использовать эту сессию."
        ...
        ExceptionTextDecodeFailure ->
            "Не удалось декодировать текст. Пожалуйста, включите `Спрашивать кодировку текста` " +
                "в настройках и повторите попытку с правильной кодировкой."
        AlertExportTips ->
            "Ваш реклист содержит предложения с японскими голосовыми знаками, " +
                ...
                "Для этого можно использовать инструмент \"File Name Normalizer\" " +
                "в меню \"Tools\" приложения \"vLabeler\"."
        ...
        AlertUnexpectedErrorOpenLog ->
            "Произошла ошибка. Пожалуйста, сообщите об этом разработчику, предоставив файл журнала ошибок."
        ...
        PreferenceGuideAudioVolume -> "Громкость гид-BGM"
        PreferencePlaybackVolume -> "Громкость воспроизведения записи"
